...
public class AddCustomer extends JFrame implements ActionListener {
    ...
    public AddCustomer() {
        ...
        // Ensure the image path exists or remove this block
        ImageIcon image = new ImageIcon(ClassLoader.getSystemResource("airways/icons/emp.png"));
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try (Connection con = conn.getConnection()) {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error adding customer details: " + e.getMessage());
        }
    }
